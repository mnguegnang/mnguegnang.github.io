...
<figure class="half">
    ...
    <figcaption><em>Figure 2: Global convergence of GD for training nonlinear neural networks on the top panel and linear networks on the bottom panel.</em></figcaption>
</figure>
