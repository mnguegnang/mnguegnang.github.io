...
Nguegnang, et \textit{al.} (2024). \href{https://doi.org/10.1186/s13662-023-03797-x}{\textbf{Convergence of gradient descent for learning linear neural networks}}. \textit{Springer Nature: Advances in Continuous and Discrete Models
Theory and Modern Applications
